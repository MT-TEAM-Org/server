...
import static org.myteam.server.match.match.domain.QMatch.match;
...
public class MatchQueryRepository {
    ...
    public List<MatchEsportsScheduleResponse> findEsportsSchedulesBetweenDate(LocalDateTime startOfDay,
        ...
        Map<String, List<Match>> groupedByYearMonth = matches.stream()
                .collect(Collectors.groupingBy(
                        match -> MatchEsportsScheduleResponse.formatLocalDateTimeToYearMonth(match.getStartTime())));
